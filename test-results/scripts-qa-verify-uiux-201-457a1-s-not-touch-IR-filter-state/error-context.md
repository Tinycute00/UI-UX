...
- Name: scripts/qa-verify-uiux-201-playwright.spec.js >> UIUX-201 Verification >> docs filter active-state only affects #v-docs/#docs-tbl and does not touch IR filter state
- Location: scripts/qa-verify-uiux-201-playwright.spec.js:35:3
