...
- Name: scripts/qa-verify-uiux-201-playwright.spec.js >> UIUX-201 Verification >> v-morning "預覽 PDF" button exists and is clickable
- Location: scripts/qa-verify-uiux-201-playwright.spec.js:95:3
...
Call log:
  - waiting for locator('#v-morning') to be visible
    63 × locator resolved to hidden <div id="v-morning" class="view active">…</div>
...
- generic [ref=e2]:
  ...
  - banner [ref=e90]:
    - generic [ref=e91]:
      - generic [ref=e92]: 工地晨會記錄
      - generic [ref=e93]: TC-2024-018 › 工地晨會記錄
    - generic [ref=e94]:
