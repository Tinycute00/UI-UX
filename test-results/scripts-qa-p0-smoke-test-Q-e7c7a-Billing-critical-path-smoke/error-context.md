...
- Name: scripts/qa-p0-smoke-test.spec.js >> QA-P0-03: Billing critical path smoke
- Location: scripts/qa-p0-smoke-test.spec.js:171:1
...
Call log:
  - waiting for locator('#v-billing') to be visible
    25 × locator resolved to hidden <div id="v-billing" class="view active">…</div>
