...
- Name: scripts/qa-verify-uiux-201-playwright.spec.js >> UIUX-201 Verification >> IR page filter-ir remains isolated to #ir-tbl
- Location: scripts/qa-verify-uiux-201-playwright.spec.js:58:3
...
Call log:
  - waiting for locator('#v-ir') to be visible
    63 × locator resolved to hidden <div id="v-ir" class="view active">…</div>
...
- generic [ref=e2]:
  ...
  - banner [ref=e90]:
    - generic [ref=e91]:
      - generic [ref=e92]: 查驗資料 (IR)
      - generic [ref=e93]: TC-2024-018 › 查驗資料 (IR)
    - generic [ref=e94]:
