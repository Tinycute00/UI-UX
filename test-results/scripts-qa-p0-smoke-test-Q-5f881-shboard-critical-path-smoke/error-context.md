...
- Name: scripts/qa-p0-smoke-test.spec.js >> QA-P0-02: Dashboard critical path smoke
- Location: scripts/qa-p0-smoke-test.spec.js:110:1
...
Call log:
  - waiting for locator('[data-action="dashboard-nav"][data-view="daily"]')
    - locator resolved to <div title="查看施工日報" data-view="daily" data-label="施工日報" class="kpi clickable" data-action="dashboard-nav">…</div>
